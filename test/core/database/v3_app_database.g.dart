...
abstract class _$V3AppDatabase extends GeneratedDatabase {
  _$V3AppDatabase(QueryExecutor e) : super(e);
  $V3AppDatabaseManager get managers => $V3AppDatabaseManager(this);
...
class $$SemestersTableFilterComposer
    extends Composer<_$V3AppDatabase, $SemestersTable> {
...
class $$SemestersTableTableManager
    extends
        RootTableManager<
          ...
          (
            Semester,
            BaseReferences<_$V3AppDatabase, $SemestersTable, Semester>,
          ),
          Semester,
          PrefetchHooks Function()
        > {
  $$SemestersTableTableManager(_$V3AppDatabase db, $SemestersTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$SemestersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$SemestersTableCreateCompanionBuilder,
      $$SemestersTableUpdateCompanionBuilder,
      (Semester, BaseReferences<_$V3AppDatabase, $SemestersTable, Semester>),
      Semester,
      PrefetchHooks Function()
    >;
...
class $$CoursesTableFilterComposer
    extends Composer<_$V3AppDatabase, $CoursesTable> {
...
class $$CoursesTableTableManager
    extends
        RootTableManager<
          ...
          (Course, BaseReferences<_$V3AppDatabase, $CoursesTable, Course>),
          Course,
          PrefetchHooks Function()
        > {
  $$CoursesTableTableManager(_$V3AppDatabase db, $CoursesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$ActivitiesTableFilterComposer
    extends Composer<_$V3AppDatabase, $ActivitiesTable> {
...
class $$ActivitiesTableTableManager
    extends
        RootTableManager<
          ...
          (
            Activity,
            BaseReferences<_$V3AppDatabase, $ActivitiesTable, Activity>,
          ),
          Activity,
          PrefetchHooks Function()
        > {
  $$ActivitiesTableTableManager(_$V3AppDatabase db, $ActivitiesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$ActivitiesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$ActivitiesTableCreateCompanionBuilder,
      $$ActivitiesTableUpdateCompanionBuilder,
      (Activity, BaseReferences<_$V3AppDatabase, $ActivitiesTable, Activity>),
      Activity,
      PrefetchHooks Function()
    >;
...
class $$SeenActivitiesTableFilterComposer
    extends Composer<_$V3AppDatabase, $SeenActivitiesTable> {
...
class $$SeenActivitiesTableTableManager
    extends
        RootTableManager<
          ...
          (
            SeenActivity,
            BaseReferences<_$V3AppDatabase, $SeenActivitiesTable, SeenActivity>,
          ),
          SeenActivity,
          PrefetchHooks Function()
        > {
...
class $$ActivityFingerprintsTableFilterComposer
    extends Composer<_$V3AppDatabase, $ActivityFingerprintsTable> {
...
class $$NotificationHistoryTableFilterComposer
    extends Composer<_$V3AppDatabase, $NotificationHistoryTable> {
...
class $$SyncRunsTableFilterComposer
    extends Composer<_$V3AppDatabase, $SyncRunsTable> {
...
class $$SyncRunsTableTableManager
    extends
        RootTableManager<
          ...
          (SyncRun, BaseReferences<_$V3AppDatabase, $SyncRunsTable, SyncRun>),
          SyncRun,
          PrefetchHooks Function()
        > {
  $$SyncRunsTableTableManager(_$V3AppDatabase db, $SyncRunsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$SyncOperationsTableFilterComposer
    extends Composer<_$V3AppDatabase, $SyncOperationsTable> {
...
typedef $$SyncOperationsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        SyncOperation,
        BaseReferences<_$V3AppDatabase, $SyncOperationsTable, SyncOperation>,
      ),
      SyncOperation,
      PrefetchHooks Function()
    >;
...
class $$AppSettingsTableFilterComposer
    extends Composer<_$V3AppDatabase, $AppSettingsTable> {
...
class $$AppSettingsTableTableManager
    extends
        RootTableManager<
          ...
          (
            AppSetting,
            BaseReferences<_$V3AppDatabase, $AppSettingsTable, AppSetting>,
          ),
          AppSetting,
          PrefetchHooks Function()
        > {
  $$AppSettingsTableTableManager(_$V3AppDatabase db, $AppSettingsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $V3AppDatabaseManager {
  final _$V3AppDatabase _db;
  $V3AppDatabaseManager(this._db);
