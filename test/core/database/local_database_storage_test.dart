...
void main() {
  ...
  test(
    'migrates a real v1 database to v13 and seeds durable baseline state',
    () async {
  ...
  test(
    'migrates a real v2 database to v13 preserving ledgers and reminders',
    () async {
      final databaseFile = await storage.resolveDatabaseFile();
  ...
  test(
    'migrates a frozen real v3 database to v13 without seeding backoff',
    () async {
      final databaseFile = await storage.resolveDatabaseFile();
  ...
  test(
    'migrates a frozen real v4 database to v13 preserving every prior table',
    () async {
      final databaseFile = await storage.resolveDatabaseFile();
  ...
  test(
    'migrates a frozen real v6 database to v13 without changing prior state',
    () async {
      final databaseFile = await storage.resolveDatabaseFile();
  ...
  test(
    'migrates a frozen connected v7 database to v13 and seeds reminder state',
    () async {
      final databaseFile = await storage.resolveDatabaseFile();
  ...
  test('migrates a frozen v8 database to v13 with monitoring off', () async {
    final databaseFile = await storage.resolveDatabaseFile();
