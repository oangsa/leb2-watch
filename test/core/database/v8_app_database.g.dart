...
class $V8ScheduledRemindersTable extends V8ScheduledReminders
    with TableInfo<$V8ScheduledRemindersTable, V8ScheduledReminder> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $V8ScheduledRemindersTable(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, int> deadlineAtUtc =
      GeneratedColumn<int>(
        ...
        $V8ScheduledRemindersTable.$converterdeadlineAtUtc,
      );
  @override
  late final GeneratedColumnWithTypeConverter<DateTime, int> scheduledForUtc =
      GeneratedColumn<int>(
        ...
        $V8ScheduledRemindersTable.$converterscheduledForUtc,
      );
  @override
  late final GeneratedColumnWithTypeConverter<DateTime, int> createdAtUtc =
      GeneratedColumn<int>(
        ...
        $V8ScheduledRemindersTable.$convertercreatedAtUtc,
      );
  ...
  static const VerificationMeta _scheduleStateMeta = const VerificationMeta(
    'scheduleState',
  );
  @override
  late final GeneratedColumn<String> scheduleState = GeneratedColumn<String>(
    'schedule_state',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<V8ScheduledReminder> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('schedule_state')) {
      context.handle(
        _scheduleStateMeta,
        scheduleState.isAcceptableOrUnknown(
          data['schedule_state']!,
          _scheduleStateMeta,
        ),
      );
  ...
  @override
  V8ScheduledReminder map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return V8ScheduledReminder(
      ...
      deadlineAtUtc: $V8ScheduledRemindersTable.$converterdeadlineAtUtc.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
          data['${effectivePrefix}deadline_at_utc'],
        )!,
      ),
      scheduledForUtc: $V8ScheduledRemindersTable.$converterscheduledForUtc
          .fromSql(
            attachedDatabase.typeMapping.read(
              DriftSqlType.int,
      ...
      createdAtUtc: $V8ScheduledRemindersTable.$convertercreatedAtUtc.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
      ...
      scheduleState: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $V8ScheduledRemindersTable createAlias(String alias) {
    return $V8ScheduledRemindersTable(attachedDatabase, alias);
  }
...
class V8ScheduledReminder extends DataClass
    implements Insertable<V8ScheduledReminder> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['offset_minutes'] = Variable<int>(offsetMinutes);
    {
      map['deadline_at_utc'] = Variable<int>(
        $V8ScheduledRemindersTable.$converterdeadlineAtUtc.toSql(deadlineAtUtc),
      );
    }
    {
      map['scheduled_for_utc'] = Variable<int>(
        $V8ScheduledRemindersTable.$converterscheduledForUtc.toSql(
          scheduledForUtc,
        ),
      );
    }
    {
      map['created_at_utc'] = Variable<int>(
        $V8ScheduledRemindersTable.$convertercreatedAtUtc.toSql(createdAtUtc),
      );
    }
  ...
  V8ScheduledRemindersCompanion toCompanion(bool nullToAbsent) {
    return V8ScheduledRemindersCompanion(
  ...
  factory V8ScheduledReminder.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  V8ScheduledReminder copyWithCompanion(V8ScheduledRemindersCompanion data) {
    return V8ScheduledReminder(
  ...
  @override
  String toString() {
    return (StringBuffer('V8ScheduledReminder(')
...
class V8ScheduledRemindersCompanion
    extends UpdateCompanion<V8ScheduledReminder> {
  ...
  const V8ScheduledRemindersCompanion({
  ...
  V8ScheduledRemindersCompanion.insert({
    this.notificationId = const Value.absent(),
    required int semesterId,
    required String identityKey,
    ...
    this.scheduleState = const Value.absent(),
       ...
       scheduledForUtc = Value(scheduledForUtc),
       createdAtUtc = Value(createdAtUtc);
  static Insertable<V8ScheduledReminder> custom({
  ...
  V8ScheduledRemindersCompanion copyWith({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (deadlineAtUtc.present) {
      map['deadline_at_utc'] = Variable<int>(
        $V8ScheduledRemindersTable.$converterdeadlineAtUtc.toSql(
          deadlineAtUtc.value,
        ),
      );
    }
    ...
    if (createdAtUtc.present) {
      map['created_at_utc'] = Variable<int>(
        $V8ScheduledRemindersTable.$convertercreatedAtUtc.toSql(
          createdAtUtc.value,
        ),
      );
    }
  ...
  @override
  String toString() {
    return (StringBuffer('V8ScheduledRemindersCompanion(')
          ..write('notificationId: $notificationId, ')
          ..write('semesterId: $semesterId, ')
          ..write('identityKey: $identityKey, ')
          ..write('offsetMinutes: $offsetMinutes, ')
...
class $DeadlineReminderPreferencesTable extends DeadlineReminderPreferences
    with
        TableInfo<
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $DeadlineReminderPreferencesTable(this.attachedDatabase, [this._alias]);
  ...
  static const VerificationMeta _oneHourEnabledMeta = const VerificationMeta(
    'oneHourEnabled',
  );
  @override
  late final GeneratedColumn<bool> oneHourEnabled = GeneratedColumn<bool>(
    'one_hour_enabled',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("one_hour_enabled" IN (0, 1))',
    ),
    defaultValue: const Constant(true),
  );
  static const VerificationMeta _twentyFourHoursEnabledMeta =
      const VerificationMeta('twentyFourHoursEnabled');
  @override
  late final GeneratedColumn<bool> twentyFourHoursEnabled =
      GeneratedColumn<bool>(
        ...
        requiredDuringInsert: false,
        defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("twenty_four_hours_enabled" IN (0, 1))',
        ),
        defaultValue: const Constant(true),
      );
  @override
  List<GeneratedColumn> get $columns => [
    ...
    enabled,
    oneHourEnabled,
    twentyFourHoursEnabled,
  ];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'deadline_reminder_preferences';
  @override
  VerificationContext validateIntegrity(
    Insertable<DeadlineReminderPreference> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('one_hour_enabled')) {
      context.handle(
        _oneHourEnabledMeta,
        oneHourEnabled.isAcceptableOrUnknown(
          data['one_hour_enabled']!,
          _oneHourEnabledMeta,
        ),
      );
    }
    if (data.containsKey('twenty_four_hours_enabled')) {
      context.handle(
        _twentyFourHoursEnabledMeta,
        twentyFourHoursEnabled.isAcceptableOrUnknown(
          data['twenty_four_hours_enabled']!,
          _twentyFourHoursEnabledMeta,
        ),
      );
    }
  ...
  @override
  DeadlineReminderPreference map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DeadlineReminderPreference(
      ...
      oneHourEnabled: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}one_hour_enabled'],
      )!,
      twentyFourHoursEnabled: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}twenty_four_hours_enabled'],
      )!,
    );
  }

  @override
  $DeadlineReminderPreferencesTable createAlias(String alias) {
    return $DeadlineReminderPreferencesTable(attachedDatabase, alias);
  }
}

class DeadlineReminderPreference extends DataClass
    implements Insertable<DeadlineReminderPreference> {
  final int singletonId;
  final bool enabled;
  final bool oneHourEnabled;
  final bool twentyFourHoursEnabled;
  const DeadlineReminderPreference({
    required this.singletonId,
    required this.enabled,
    required this.oneHourEnabled,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['one_hour_enabled'] = Variable<bool>(oneHourEnabled);
    map['twenty_four_hours_enabled'] = Variable<bool>(twentyFourHoursEnabled);
    return map;
  }

  DeadlineReminderPreferencesCompanion toCompanion(bool nullToAbsent) {
    return DeadlineReminderPreferencesCompanion(
      singletonId: Value(singletonId),
      enabled: Value(enabled),
      oneHourEnabled: Value(oneHourEnabled),
      twentyFourHoursEnabled: Value(twentyFourHoursEnabled),
    );
  }

  factory DeadlineReminderPreference.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DeadlineReminderPreference(
      ...
      oneHourEnabled: serializer.fromJson<bool>(json['oneHourEnabled']),
      twentyFourHoursEnabled: serializer.fromJson<bool>(
        json['twentyFourHoursEnabled'],
      ),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'oneHourEnabled': serializer.toJson<bool>(oneHourEnabled),
      'twentyFourHoursEnabled': serializer.toJson<bool>(twentyFourHoursEnabled),
    };
  }

  DeadlineReminderPreference copyWith({
    int? singletonId,
    bool? enabled,
    bool? oneHourEnabled,
    bool? twentyFourHoursEnabled,
  }) => DeadlineReminderPreference(
    singletonId: singletonId ?? this.singletonId,
    enabled: enabled ?? this.enabled,
    oneHourEnabled: oneHourEnabled ?? this.oneHourEnabled,
    twentyFourHoursEnabled:
        twentyFourHoursEnabled ?? this.twentyFourHoursEnabled,
  );
  DeadlineReminderPreference copyWithCompanion(
    DeadlineReminderPreferencesCompanion data,
  ) {
    return DeadlineReminderPreference(
      ...
      oneHourEnabled: data.oneHourEnabled.present
          ? data.oneHourEnabled.value
          : this.oneHourEnabled,
      twentyFourHoursEnabled: data.twentyFourHoursEnabled.present
          ? data.twentyFourHoursEnabled.value
          : this.twentyFourHoursEnabled,
    );
  }

  @override
  String toString() {
    return (StringBuffer('DeadlineReminderPreference(')
          ..write('singletonId: $singletonId, ')
          ..write('enabled: $enabled, ')
          ..write('oneHourEnabled: $oneHourEnabled, ')
          ..write('twentyFourHoursEnabled: $twentyFourHoursEnabled')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode =>
      Object.hash(singletonId, enabled, oneHourEnabled, twentyFourHoursEnabled);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DeadlineReminderPreference &&
          other.singletonId == this.singletonId &&
          other.enabled == this.enabled &&
          other.oneHourEnabled == this.oneHourEnabled &&
          other.twentyFourHoursEnabled == this.twentyFourHoursEnabled);
}

class DeadlineReminderPreferencesCompanion
    extends UpdateCompanion<DeadlineReminderPreference> {
  final Value<int> singletonId;
  final Value<bool> enabled;
  final Value<bool> oneHourEnabled;
  final Value<bool> twentyFourHoursEnabled;
  const DeadlineReminderPreferencesCompanion({
    this.singletonId = const Value.absent(),
    this.enabled = const Value.absent(),
    this.oneHourEnabled = const Value.absent(),
    this.twentyFourHoursEnabled = const Value.absent(),
  });
  DeadlineReminderPreferencesCompanion.insert({
    this.singletonId = const Value.absent(),
    this.enabled = const Value.absent(),
    this.oneHourEnabled = const Value.absent(),
    this.twentyFourHoursEnabled = const Value.absent(),
  });
  static Insertable<DeadlineReminderPreference> custom({
    Expression<int>? singletonId,
    Expression<bool>? enabled,
    Expression<bool>? oneHourEnabled,
    Expression<bool>? twentyFourHoursEnabled,
  }) {
    return RawValuesInsertable({
      if (singletonId != null) 'singleton_id': singletonId,
      if (enabled != null) 'enabled': enabled,
      if (oneHourEnabled != null) 'one_hour_enabled': oneHourEnabled,
      if (twentyFourHoursEnabled != null)
        'twenty_four_hours_enabled': twentyFourHoursEnabled,
    });
  }

  DeadlineReminderPreferencesCompanion copyWith({
    Value<int>? singletonId,
    Value<bool>? enabled,
    Value<bool>? oneHourEnabled,
    Value<bool>? twentyFourHoursEnabled,
  }) {
    return DeadlineReminderPreferencesCompanion(
      singletonId: singletonId ?? this.singletonId,
      enabled: enabled ?? this.enabled,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (oneHourEnabled.present) {
      map['one_hour_enabled'] = Variable<bool>(oneHourEnabled.value);
    }
    if (twentyFourHoursEnabled.present) {
      map['twenty_four_hours_enabled'] = Variable<bool>(
        twentyFourHoursEnabled.value,
      );
    }
    return map;
  }
  ...
  @override
  String toString() {
    return (StringBuffer('DeadlineReminderPreferencesCompanion(')
          ..write('singletonId: $singletonId, ')
          ..write('enabled: $enabled, ')
          ..write('oneHourEnabled: $oneHourEnabled, ')
          ..write('twentyFourHoursEnabled: $twentyFourHoursEnabled')
...
class $V8DeadlineReminderReconciliationsTable
    extends V8DeadlineReminderReconciliations
    with
        TableInfo<
          $V8DeadlineReminderReconciliationsTable,
          V8DeadlineReminderReconciliation
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $V8DeadlineReminderReconciliationsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _singletonIdMeta = const VerificationMeta(
    'singletonId',
  );
  @override
  ...
  static const VerificationMeta _requestedGenerationMeta =
      const VerificationMeta('requestedGeneration');
  @override
  late final GeneratedColumn<int> requestedGeneration = GeneratedColumn<int>(
  ...
  static const VerificationMeta _completedGenerationMeta =
      const VerificationMeta('completedGeneration');
  @override
  late final GeneratedColumn<int> completedGeneration = GeneratedColumn<int>(
  ...
  leaseExpiresAtUtc =
      GeneratedColumn<int>(
        ...
        $V8DeadlineReminderReconciliationsTable.$converterleaseExpiresAtUtcn,
      );
  @override
  List<GeneratedColumn> get $columns => [
    singletonId,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'deadline_reminder_reconciliations';
  @override
  VerificationContext validateIntegrity(
    Insertable<V8DeadlineReminderReconciliation> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('requested_generation')) {
      context.handle(
        _requestedGenerationMeta,
        requestedGeneration.isAcceptableOrUnknown(
          data['requested_generation']!,
          _requestedGenerationMeta,
        ),
      );
    }
    if (data.containsKey('completed_generation')) {
      context.handle(
        _completedGenerationMeta,
        completedGeneration.isAcceptableOrUnknown(
          data['completed_generation']!,
          _completedGenerationMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {singletonId};
  @override
  V8DeadlineReminderReconciliation map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return V8DeadlineReminderReconciliation(
      singletonId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}singleton_id'],
      )!,
      requestedGeneration: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}requested_generation'],
      )!,
      completedGeneration: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}completed_generation'],
      )!,
      ownerToken: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}owner_token'],
      ),
      leaseExpiresAtUtc: $V8DeadlineReminderReconciliationsTable
  ...
  @override
  $V8DeadlineReminderReconciliationsTable createAlias(String alias) {
    return $V8DeadlineReminderReconciliationsTable(attachedDatabase, alias);
  }
...
class V8DeadlineReminderReconciliation extends DataClass
    implements Insertable<V8DeadlineReminderReconciliation> {
  final int singletonId;
  final int requestedGeneration;
  final int completedGeneration;
  final String? ownerToken;
  final DateTime? leaseExpiresAtUtc;
  const V8DeadlineReminderReconciliation({
    required this.singletonId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['singleton_id'] = Variable<int>(singletonId);
    map['requested_generation'] = Variable<int>(requestedGeneration);
    map['completed_generation'] = Variable<int>(completedGeneration);
    if (!nullToAbsent || ownerToken != null) {
      map['owner_token'] = Variable<String>(ownerToken);
    }
    if (!nullToAbsent || leaseExpiresAtUtc != null) {
  ...
  V8DeadlineReminderReconciliationsCompanion toCompanion(bool nullToAbsent) {
    return V8DeadlineReminderReconciliationsCompanion(
      singletonId: Value(singletonId),
      requestedGeneration: Value(requestedGeneration),
      completedGeneration: Value(completedGeneration),
      ownerToken: ownerToken == null && nullToAbsent
          ? const Value.absent()
          : Value(ownerToken),
      leaseExpiresAtUtc: leaseExpiresAtUtc == null && nullToAbsent
  ...
  factory V8DeadlineReminderReconciliation.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return V8DeadlineReminderReconciliation(
      singletonId: serializer.fromJson<int>(json['singletonId']),
      requestedGeneration: serializer.fromJson<int>(
        json['requestedGeneration'],
      ),
      completedGeneration: serializer.fromJson<int>(
        json['completedGeneration'],
      ),
      ownerToken: serializer.fromJson<String?>(json['ownerToken']),
      leaseExpiresAtUtc: serializer.fromJson<DateTime?>(
        json['leaseExpiresAtUtc'],
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'singletonId': serializer.toJson<int>(singletonId),
      'requestedGeneration': serializer.toJson<int>(requestedGeneration),
  ...
  V8DeadlineReminderReconciliation copyWith({
    int? singletonId,
  ...
  V8DeadlineReminderReconciliation copyWithCompanion(
    V8DeadlineReminderReconciliationsCompanion data,
  ) {
    return V8DeadlineReminderReconciliation(
      singletonId: data.singletonId.present
          ? data.singletonId.value
          : this.singletonId,
      requestedGeneration: data.requestedGeneration.present
          ? data.requestedGeneration.value
          : this.requestedGeneration,
      completedGeneration: data.completedGeneration.present
          ? data.completedGeneration.value
  ...
  @override
  String toString() {
    return (StringBuffer('V8DeadlineReminderReconciliation(')
          ..write('singletonId: $singletonId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is V8DeadlineReminderReconciliation &&
          other.singletonId == this.singletonId &&
...
class V8DeadlineReminderReconciliationsCompanion
    extends UpdateCompanion<V8DeadlineReminderReconciliation> {
  final Value<int> singletonId;
  final Value<int> requestedGeneration;
  final Value<int> completedGeneration;
  final Value<String?> ownerToken;
  final Value<DateTime?> leaseExpiresAtUtc;
  const V8DeadlineReminderReconciliationsCompanion({
    this.singletonId = const Value.absent(),
  ...
  V8DeadlineReminderReconciliationsCompanion.insert({
    this.singletonId = const Value.absent(),
    this.requestedGeneration = const Value.absent(),
    this.completedGeneration = const Value.absent(),
    this.ownerToken = const Value.absent(),
  ...
  static Insertable<V8DeadlineReminderReconciliation> custom({
    Expression<int>? singletonId,
    Expression<int>? requestedGeneration,
  ...
  V8DeadlineReminderReconciliationsCompanion copyWith({
    Value<int>? singletonId,
    Value<int>? requestedGeneration,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (requestedGeneration.present) {
      map['requested_generation'] = Variable<int>(requestedGeneration.value);
    }
    if (completedGeneration.present) {
      map['completed_generation'] = Variable<int>(completedGeneration.value);
    }
    if (ownerToken.present) {
      map['owner_token'] = Variable<String>(ownerToken.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('V8DeadlineReminderReconciliationsCompanion(')
          ..write('singletonId: $singletonId, ')
          ..write('requestedGeneration: $requestedGeneration, ')
          ..write('completedGeneration: $completedGeneration, ')
          ..write('ownerToken: $ownerToken, ')
...
abstract class _$V8AppDatabase extends GeneratedDatabase {
  _$V8AppDatabase(QueryExecutor e) : super(e);
  $V8AppDatabaseManager get managers => $V8AppDatabaseManager(this);
  ...
  late final $V8ScheduledRemindersTable v8ScheduledReminders =
      $V8ScheduledRemindersTable(this);
  ...
  late final $DeadlineReminderPreferencesTable deadlineReminderPreferences =
      $DeadlineReminderPreferencesTable(this);
  late final $V8DeadlineReminderReconciliationsTable
  v8DeadlineReminderReconciliations = $V8DeadlineReminderReconciliationsTable(
    this,
  );
...
class $$SemestersTableFilterComposer
    extends Composer<_$V8AppDatabase, $SemestersTable> {
...
class $$SemestersTableTableManager
    extends
        RootTableManager<
          ...
          (
            Semester,
            BaseReferences<_$V8AppDatabase, $SemestersTable, Semester>,
          ),
          Semester,
          PrefetchHooks Function()
        > {
  $$SemestersTableTableManager(_$V8AppDatabase db, $SemestersTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$SemestersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$SemestersTableCreateCompanionBuilder,
      $$SemestersTableUpdateCompanionBuilder,
      (Semester, BaseReferences<_$V8AppDatabase, $SemestersTable, Semester>),
      Semester,
      PrefetchHooks Function()
    >;
...
class $$CoursesTableFilterComposer
    extends Composer<_$V8AppDatabase, $CoursesTable> {
...
class $$CoursesTableTableManager
    extends
        RootTableManager<
          ...
          (Course, BaseReferences<_$V8AppDatabase, $CoursesTable, Course>),
          Course,
          PrefetchHooks Function()
        > {
  $$CoursesTableTableManager(_$V8AppDatabase db, $CoursesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$CoursePreferencesTableFilterComposer
    extends Composer<_$V8AppDatabase, $CoursePreferencesTable> {
...
class $$ActivitiesTableFilterComposer
    extends Composer<_$V8AppDatabase, $ActivitiesTable> {
...
class $$ActivitiesTableTableManager
    extends
        RootTableManager<
          ...
          (
            Activity,
            BaseReferences<_$V8AppDatabase, $ActivitiesTable, Activity>,
          ),
          Activity,
          PrefetchHooks Function()
        > {
  $$ActivitiesTableTableManager(_$V8AppDatabase db, $ActivitiesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$ActivitiesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$ActivitiesTableCreateCompanionBuilder,
      $$ActivitiesTableUpdateCompanionBuilder,
      (Activity, BaseReferences<_$V8AppDatabase, $ActivitiesTable, Activity>),
      Activity,
      PrefetchHooks Function()
    >;
...
class $$SeenActivitiesTableFilterComposer
    extends Composer<_$V8AppDatabase, $SeenActivitiesTable> {
...
class $$SeenActivitiesTableTableManager
    extends
        RootTableManager<
          ...
          (
            SeenActivity,
            BaseReferences<_$V8AppDatabase, $SeenActivitiesTable, SeenActivity>,
          ),
          SeenActivity,
          PrefetchHooks Function()
        > {
...
class $$ActivityFingerprintsTableFilterComposer
    extends Composer<_$V8AppDatabase, $ActivityFingerprintsTable> {
...
typedef $$ActivityFingerprintsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$V8ScheduledRemindersTableCreateCompanionBuilder =
    V8ScheduledRemindersCompanion Function({
      Value<int> notificationId,
      required int semesterId,
      required String identityKey,
      required int offsetMinutes,
...
typedef $$V8ScheduledRemindersTableUpdateCompanionBuilder =
    V8ScheduledRemindersCompanion Function({
      Value<int> notificationId,
      Value<int> semesterId,
      Value<String> identityKey,
...
class $$V8ScheduledRemindersTableFilterComposer
    extends Composer<_$V8AppDatabase, $V8ScheduledRemindersTable> {
  $$V8ScheduledRemindersTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get scheduleState => $composableBuilder(
    column: $table.scheduleState,
    builder: (column) => ColumnFilters(column),
  );
}

class $$V8ScheduledRemindersTableOrderingComposer
    extends Composer<_$V8AppDatabase, $V8ScheduledRemindersTable> {
  $$V8ScheduledRemindersTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$V8ScheduledRemindersTableAnnotationComposer
    extends Composer<_$V8AppDatabase, $V8ScheduledRemindersTable> {
  $$V8ScheduledRemindersTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get scheduleState => $composableBuilder(
    column: $table.scheduleState,
    builder: (column) => column,
  );
}

class $$V8ScheduledRemindersTableTableManager
    extends
        RootTableManager<
          _$V8AppDatabase,
          $V8ScheduledRemindersTable,
          V8ScheduledReminder,
          $$V8ScheduledRemindersTableFilterComposer,
          $$V8ScheduledRemindersTableOrderingComposer,
          $$V8ScheduledRemindersTableAnnotationComposer,
          $$V8ScheduledRemindersTableCreateCompanionBuilder,
          $$V8ScheduledRemindersTableUpdateCompanionBuilder,
          (
            V8ScheduledReminder,
            BaseReferences<
              _$V8AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$V8ScheduledRemindersTableTableManager(
    _$V8AppDatabase db,
    $V8ScheduledRemindersTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$V8ScheduledRemindersTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$V8ScheduledRemindersTableOrderingComposer(
                $db: db,
                $table: table,
...
typedef $$V8ScheduledRemindersTableProcessedTableManager =
    ProcessedTableManager<
      _$V8AppDatabase,
      $V8ScheduledRemindersTable,
      V8ScheduledReminder,
...
class $$NotificationHistoryTableFilterComposer
    extends Composer<_$V8AppDatabase, $NotificationHistoryTable> {
...
class $$SyncRunsTableFilterComposer
    extends Composer<_$V8AppDatabase, $SyncRunsTable> {
...
class $$SyncRunsTableTableManager
    extends
        RootTableManager<
          ...
          (SyncRun, BaseReferences<_$V8AppDatabase, $SyncRunsTable, SyncRun>),
          SyncRun,
          PrefetchHooks Function()
        > {
  $$SyncRunsTableTableManager(_$V8AppDatabase db, $SyncRunsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$SyncOperationsTableFilterComposer
    extends Composer<_$V8AppDatabase, $SyncOperationsTable> {
...
typedef $$SyncOperationsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        SyncOperation,
        BaseReferences<_$V8AppDatabase, $SyncOperationsTable, SyncOperation>,
      ),
      SyncOperation,
      PrefetchHooks Function()
    >;
...
class $$AssignmentBaselinesTableFilterComposer
    extends Composer<_$V8AppDatabase, $AssignmentBaselinesTable> {
...
class $$SyncOperationChangesTableFilterComposer
    extends Composer<_$V8AppDatabase, $SyncOperationChangesTable> {
...
class $$SyncBackoffStatesTableFilterComposer
    extends Composer<_$V8AppDatabase, $SyncBackoffStatesTable> {
...
typedef $$SyncBackoffStatesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$DeadlineReminderPreferencesTableCreateCompanionBuilder =
    DeadlineReminderPreferencesCompanion Function({
      Value<int> singletonId,
      Value<bool> enabled,
      Value<bool> oneHourEnabled,
      Value<bool> twentyFourHoursEnabled,
    });
typedef $$DeadlineReminderPreferencesTableUpdateCompanionBuilder =
    DeadlineReminderPreferencesCompanion Function({
      Value<int> singletonId,
      Value<bool> enabled,
      Value<bool> oneHourEnabled,
...
class $$DeadlineReminderPreferencesTableFilterComposer
    extends Composer<_$V8AppDatabase, $DeadlineReminderPreferencesTable> {
  ...
  ColumnFilters<bool> get oneHourEnabled => $composableBuilder(
    column: $table.oneHourEnabled,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<bool> get twentyFourHoursEnabled => $composableBuilder(
    column: $table.twentyFourHoursEnabled,
    builder: (column) => ColumnFilters(column),
  );
}
...
class $$DeadlineReminderPreferencesTableOrderingComposer
  ...
  ColumnOrderings<bool> get oneHourEnabled => $composableBuilder(
    column: $table.oneHourEnabled,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<bool> get twentyFourHoursEnabled => $composableBuilder(
    column: $table.twentyFourHoursEnabled,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$DeadlineReminderPreferencesTableAnnotationComposer
  ...
  GeneratedColumn<bool> get oneHourEnabled => $composableBuilder(
    column: $table.oneHourEnabled,
    builder: (column) => column,
  );

  GeneratedColumn<bool> get twentyFourHoursEnabled => $composableBuilder(
    column: $table.twentyFourHoursEnabled,
    builder: (column) => column,
  );
}
...
class $$DeadlineReminderPreferencesTableTableManager
    extends
        RootTableManager<
          ...
          $$DeadlineReminderPreferencesTableOrderingComposer,
          $$DeadlineReminderPreferencesTableAnnotationComposer,
          $$DeadlineReminderPreferencesTableCreateCompanionBuilder,
          $$DeadlineReminderPreferencesTableUpdateCompanionBuilder,
          (
            DeadlineReminderPreference,
            BaseReferences<
              _$V8AppDatabase,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<bool> oneHourEnabled = const Value.absent(),
                Value<bool> twentyFourHoursEnabled = const Value.absent(),
              }) => DeadlineReminderPreferencesCompanion(
                singletonId: singletonId,
                enabled: enabled,
                oneHourEnabled: oneHourEnabled,
                twentyFourHoursEnabled: twentyFourHoursEnabled,
              ),
          createCompanionCallback:
              ({
                Value<int> singletonId = const Value.absent(),
...
typedef $$DeadlineReminderPreferencesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$V8DeadlineReminderReconciliationsTableCreateCompanionBuilder =
    V8DeadlineReminderReconciliationsCompanion Function({
      Value<int> singletonId,
      Value<int> requestedGeneration,
      Value<int> completedGeneration,
      Value<String?> ownerToken,
...
typedef $$V8DeadlineReminderReconciliationsTableUpdateCompanionBuilder =
    V8DeadlineReminderReconciliationsCompanion Function({
      Value<int> singletonId,
      Value<int> requestedGeneration,
      Value<int> completedGeneration,
...
class $$V8DeadlineReminderReconciliationsTableFilterComposer
    extends Composer<_$V8AppDatabase, $V8DeadlineReminderReconciliationsTable> {
  $$V8DeadlineReminderReconciliationsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<int> get requestedGeneration => $composableBuilder(
    column: $table.requestedGeneration,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get completedGeneration => $composableBuilder(
    column: $table.completedGeneration,
    builder: (column) => ColumnFilters(column),
  );
...
class $$V8DeadlineReminderReconciliationsTableOrderingComposer
    extends Composer<_$V8AppDatabase, $V8DeadlineReminderReconciliationsTable> {
  $$V8DeadlineReminderReconciliationsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<int> get requestedGeneration => $composableBuilder(
    column: $table.requestedGeneration,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get completedGeneration => $composableBuilder(
    column: $table.completedGeneration,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$V8DeadlineReminderReconciliationsTableAnnotationComposer
    extends Composer<_$V8AppDatabase, $V8DeadlineReminderReconciliationsTable> {
  $$V8DeadlineReminderReconciliationsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<int> get requestedGeneration => $composableBuilder(
    column: $table.requestedGeneration,
    builder: (column) => column,
  );

  GeneratedColumn<int> get completedGeneration => $composableBuilder(
    column: $table.completedGeneration,
    builder: (column) => column,
  );
...
class $$V8DeadlineReminderReconciliationsTableTableManager
    extends
        RootTableManager<
          _$V8AppDatabase,
          $V8DeadlineReminderReconciliationsTable,
          ...
          $$V8DeadlineReminderReconciliationsTableOrderingComposer,
          $$V8DeadlineReminderReconciliationsTableAnnotationComposer,
          $$V8DeadlineReminderReconciliationsTableCreateCompanionBuilder,
          $$V8DeadlineReminderReconciliationsTableUpdateCompanionBuilder,
          (
            V8DeadlineReminderReconciliation,
            BaseReferences<
              _$V8AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$V8DeadlineReminderReconciliationsTableTableManager(
    _$V8AppDatabase db,
    $V8DeadlineReminderReconciliationsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                Value<int> singletonId = const Value.absent(),
                Value<int> requestedGeneration = const Value.absent(),
                Value<int> completedGeneration = const Value.absent(),
                Value<String?> ownerToken = const Value.absent(),
                Value<DateTime?> leaseExpiresAtUtc = const Value.absent(),
              }) => V8DeadlineReminderReconciliationsCompanion(
                singletonId: singletonId,
...
typedef $$V8DeadlineReminderReconciliationsTableProcessedTableManager =
    ProcessedTableManager<
      _$V8AppDatabase,
      $V8DeadlineReminderReconciliationsTable,
      V8DeadlineReminderReconciliation,
...
class $$AppSettingsTableFilterComposer
    extends Composer<_$V8AppDatabase, $AppSettingsTable> {
...
class $$AppSettingsTableTableManager
    extends
        RootTableManager<
          ...
          (
            AppSetting,
            BaseReferences<_$V8AppDatabase, $AppSettingsTable, AppSetting>,
          ),
          AppSetting,
          PrefetchHooks Function()
        > {
  $$AppSettingsTableTableManager(_$V8AppDatabase db, $AppSettingsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $V8AppDatabaseManager {
  final _$V8AppDatabase _db;
  $V8AppDatabaseManager(this._db);
  ...
  $$V8ScheduledRemindersTableTableManager get v8ScheduledReminders =>
      $$V8ScheduledRemindersTableTableManager(_db, _db.v8ScheduledReminders);
  ...
  $$DeadlineReminderPreferencesTableTableManager
  get deadlineReminderPreferences =>
      $$DeadlineReminderPreferencesTableTableManager(
        _db,
        _db.deadlineReminderPreferences,
      );
  $$V8DeadlineReminderReconciliationsTableTableManager
  get v8DeadlineReminderReconciliations =>
      $$V8DeadlineReminderReconciliationsTableTableManager(
        _db,
        _db.v8DeadlineReminderReconciliations,
      );
